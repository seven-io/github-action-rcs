...
const send = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const client = new client_1.Client({ apiKey, sentWith: 'github-action-rcs' });
        const resource = new client_1.RcsResource(client);
        const response = yield resource.dispatch(rcsParams);
        (0, core_1.debug)('API reached, RCS dispatch ended.');
